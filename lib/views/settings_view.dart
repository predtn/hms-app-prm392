        ...
        children: [
          if (canManageHotelConfig) ...[
            ...
            ListTile(
              ...
              subtitle: const Text('Các phí phạt qua giờ'),
              onTap: () {
          ...
          Padding(
            padding: EdgeInsets.only(
              left: 16.0,
              right: 16.0,
              top: canManageHotelConfig ? 16.0 : 24.0,
              bottom: 8.0,
            ),
            child: Text(
              'Cài đặt hệ thống',
          ...
          RadioGroup<String>(
            ...
            child: const Column(
              children: [
                RadioListTile<String>(title: Text('Sáng'), value: 'light'),
                RadioListTile<String>(title: Text('Tối'), value: 'dark'),
                RadioListTile<String>(title: Text('Hệ thống'), value: 'system'),
              ],
            ),
          ),
          const Padding(
